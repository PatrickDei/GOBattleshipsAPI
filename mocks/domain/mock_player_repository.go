...
func (m *MockPlayerRepository) ExistsById(arg0 string) (bool, *errors.AppError) {
	m.ctrl.T.Helper()
...
func (mr *MockPlayerRepositoryMockRecorder) ExistsById(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ExistsById", reflect.TypeOf((*MockPlayerRepository)(nil).ExistsById), arg0)
}

// GetAll mocks base method.
func (m *MockPlayerRepository) GetAll() ([]domain.Player, *errors.AppError) {
	m.ctrl.T.Helper()
